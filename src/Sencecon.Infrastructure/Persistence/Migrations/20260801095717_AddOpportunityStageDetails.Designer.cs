...
namespace Sencecon.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260801095717_AddOpportunityStageDetails")]
    partial class AddOpportunityStageDetails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sencecon.Domain.Entities.Opportunity", b =>
                {
                    ...
                    b.Property<string>("SiteVisitNotes")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<DateTimeOffset?>("WonDate")
                        .HasColumnType("timestamp with time zone");
